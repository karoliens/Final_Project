    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 1, 18, 11, 33, 23, 839, DateTimeKind.Local).AddTicks(8670), "Reikia pakeisti iPhone 7 ekraną", 1, 2, 1 },
                    { 2, 2, new DateTime(2023, 1, 18, 11, 33, 23, 839, DateTimeKind.Local).AddTicks(8706), "Reikia pakeisti iPhone X bateriją", 2, 3, 2 },
                    { 3, 3, new DateTime(2023, 1, 18, 11, 33, 23, 839, DateTimeKind.Local).AddTicks(8708), "Reikia pakeisti SAMSUNG S20 ekraną", 2, 2, 1 },
                    { 4, 4, new DateTime(2023, 1, 18, 11, 33, 23, 839, DateTimeKind.Local).AddTicks(8710), "Reikia perlituoti PS5 pultelio krovimo lizdą", 2, 4, 3 }
                });
